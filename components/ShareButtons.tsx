...
export default function ShareButtons({ url, title }: Props) {
  ...
  return (
    <div style={{ borderTop: '1px solid var(--border)', paddingTop: 28, marginBottom: 56 }}>
      <p style={{ color: 'var(--muted)', fontSize: '0.78rem', marginBottom: 14, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.06em' }}>
        Share this digest
      </p>
      <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
        ...
        <a
          ...
          rel="noopener noreferrer"
          style={BTN}
          onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = '#229ED9'; (e.currentTarget as HTMLElement).style.color = '#229ED9' }}
          onMouseLeave={e => { (e.currentTarget as HTMLElement).style.borderColor = 'var(--border)'; (e.currentTarget as HTMLElement).style.color = 'var(--text)' }}
        >
          <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
        ...
        <button
          ...
          style={{
            ...BTN,
            borderColor: copied ? 'var(--green, #10b981)' : 'var(--border)',
            color:        copied ? 'var(--green, #10b981)' : 'var(--text)',
          }}
          onMouseEnter={e => { if (!copied) { (e.currentTarget as HTMLElement).style.borderColor = '#6b7280'; } }}
